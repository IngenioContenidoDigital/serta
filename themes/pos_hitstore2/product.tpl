...
<div itemscope itemtype="http://schema.org/Product">
	...
	<div class="primary_block row">
		...
		{/if}
		<!-- left infos-->
		<div class="pb-left-column {if !$content_only}col-xs-12 col-sm-4 col-md-4{else}col-xs-12 col-sm-6 col-md-6{/if}">
			<!-- product img-->
		...
		<!-- end left infos-->
		<!-- center infos -->
		<div class="pb-center-column  {if !$content_only} col-xs-12 col-sm-5 col-md-5 {else}col-xs-12 col-sm-6 col-md-6 {/if}">
...
<div class="more-info">
	<ul id="more_info_tabs" class="idTabs idTabsShort">
		...
		{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}<li><a href="#idTab11">{l s='Volume discounts'}</a></li>{/if}
		{if isset($packItems) && $packItems|@count > 0}<li><a href="#idTab12">{l s='Pack content'}</a></li>{/if}
	...
	<div class="tab-content">
		...
		<!--HOOK_PRODUCT_TAB -->
			...
			<!--Accessories -->
			<section class="page-product-box pos-block listproducts">
				<div class="pos_title">
				<h4>
				...
				<div class="block products_block accessories-pos row">
													...
													{if !$PS_CATALOG_MODE && ($accessory.allow_oosp || $accessory.quantity > 0)}
														<li class="posbuttonCart">
															<a class="exclusive button ajax_add_to_cart_button" href="{$link->getPageLink('cart', true, NULL, 'qty=1&amp;id_product={$accessory.id_product|intval}&amp;token={$static_token}&amp;add')|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product|intval}" title="{l s='Add to cart'}">
																<i class="icon-shopping-cart"></i><span>{l s='Add to cart'}</span>
															</a>
														</li>
													{/if}
														<li>
