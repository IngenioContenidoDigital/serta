...
<p style="text-align: center;"><span style="font-size: 24pt;"> ¡Tu pedido</span></p>
<p style="text-align: center;"><span style="font-size: 24pt;">se ha registrado con Exito!</span></p>
{if $message_payu != ''}
<p style="text-align: center;"><span style="font-size: 14pt; background-color: #F3F781;"><b>Estado de transacción: {$message_payu}</b></span></p>
{/if}
{if isset($payu) && $payu!=false }
<p class="cart_navigation clearfix">
	<a title="Ver recibo de pago" class="button btn btn-default button-medium" href="{$URL_PAYMENT_RECEIPT_HTML}" style="">
		<span>Ver recibo de pago<i class="icon-chevron-right right"></i></span>
	</a> 
	</p>
{/if}
