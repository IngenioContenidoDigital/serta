...
<div id="newsletter_block_left" class="footer-block col-lg-3 col-md-3  col-sm-3 col-xs-12">
	<h4><span>{l s='Newsletter' mod='blocknewsletter'}</span></h4>
	<div class="block_content toggle-footer">
		<p>{l s='Subscribe to the Manina mailing list to receive updates on new arrivals, special offers and other discount information.' mod='blocknewsletter'}</p>
