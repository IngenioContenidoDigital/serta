...
{ 
	...
	//$("ul.product_list.list .product-image-container > div.hoverimage").remove();	
})
...
{
	var screenLg = $('body').find('.container').width() == 1150;
...
function display(view)
{
	if (view == 'list')
	{
		...
		$('.product_list > li').removeClass('col-xs-4 col-sm-4 col-md-3').addClass('col-xs-12');
		$('.product_list > li').each(function(index, element) {
			var html = '';
			html = '<div class="product-container"><div class="row">';
				html += '<div class="left-block col-xs-4 col-xs-5 col-md-3">' + $(element).find('.left-block').html();
				
				html += '</div>';	
				html += '<div class="right-block col-xs-4 col-xs-7 col-md-9"><div class="right-block-content">';
	...
	else
	{
		...
		$('.product_list > li').removeClass('col-xs-12').addClass('col-xs-4 col-sm-4 col-md-3');
		$('.product_list > li').each(function(index, element) {
		html = '';
