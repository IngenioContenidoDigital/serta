...
{if isset($orderProducts) && count($orderProducts) > 0}
	<div class="crossseling-content">
		<h2 class="centertitle_block">{l s='Customers who bought this product also bought:' mod='blockcart'}</h2>
					...
					<li>
						<div class="product-image-container">
							<a href="{$orderProduct.link|escape:'html':'UTF-8'}" title="{$orderProduct.name|htmlspecialchars}" class="lnk_img">
								<img class="img-responsive" src="{$link->getImageLink($orderProduct.link_rewrite, $orderProduct.id_image, 'home_default')|escape:'html'}" alt="{$orderProduct.name|htmlspecialchars}" />
