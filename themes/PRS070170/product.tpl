	...
	<div class="primary_block row">
		...
		<div class="pb-left-column col-xs-12 col-sm-5 col-md-6">
			...
			<h1 itemprop="name">{$product->name|escape:'html':'UTF-8'}</h1>
                        <p class="our_price_display precio" itemprop="offers" itemscope itemtype="https://schema.org/Offer">{strip}
		...
		<div class="pb-center-column col-xs-12 col-sm-7 col-md-6">
			...
			<div id="image-block" class="clearfix">
				...
				{/if}
				{if $have_image}
					<span id="view_full_size" style="float:right;">
						{if $jqZoomEnabled && $have_image && !$content_only}
							<a class="jqzoom" title="{if !empty($cover.legend)}{$cover.legend|escape:'html':'UTF-8'}{else}{$product->name|escape:'html':'UTF-8'}{/if}" rel="gal1" href="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'thickbox_default')|escape:'html':'UTF-8'}">
								<img itemprop="image" src="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'large_default')|escape:'html':'UTF-8'}" title="{if !empty($cover.legend)}{$cover.legend|escape:'html':'UTF-8'}{else}{$product->name|escape:'html':'UTF-8'}{/if}" alt="{if !empty($cover.legend)}{$cover.legend|escape:'html':'UTF-8'}{else}{$product->name|escape:'html':'UTF-8'}{/if}"/>
							</a>
						{else}
							<img id="bigpic" itemprop="image" src="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'large_default')|escape:'html':'UTF-8'}" data-zoom-image="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'thickbox_default')|escape:'html':'UTF-8'}" title="{if !empty($cover.legend)}{$cover.legend|escape:'html':'UTF-8'}{else}{$product->name|escape:'html':'UTF-8'}{/if}" alt="{if !empty($cover.legend)}{$cover.legend|escape:'html':'UTF-8'}{else}{$product->name|escape:'html':'UTF-8'}{/if}" width="{$largeSize.width}" height="{$largeSize.height}"/>
							{*if !$content_only}
...
<section class="tm-tabcontent">		
	<ul id="productpage_tab" class="nav nav-tabs clearfix">
		{*if $product->description}
			<li class="active"><a data-toggle="tab" href="#tmmoreinfo" class="tmmoreinfo">{l s='More info'}</a></li>
		{/if*}
		{if isset($features) && $features}
			<li><a data-toggle="tab" href="#tmdatasheet" class="tmdatasheet">{l s='Data sheet'}</a></li>
		{/if}	
		{if isset($attachments) && $attachments}
			<li><a data-toggle="tab" href="#tmdownlaod" class="tmdownlaod">{l s='Download'}</a></li>
		{/if}
		{if isset($product) && $product->customizable}
			<li><a data-toggle="tab" href="#tmcustomize" class="tmcustomize">{l s='Product customization'}</a></li>
		{/if}	
	</ul>
	<div class="tab-content">
		...
		<!-- Customization -->
		{if isset($product) && $product->customizable}
			<ul id="tmcustomize" class="tm_productinner tab-pane"><li>
...
<!-- Megnor TAB : END-->		
		...
		{if isset($accessories) && $accessories}
			...
			<section class="page-product-box accessories-product">
				<h2 class="centertitle_block">{l s='Accessories'}</h2>
				<div class="block products_block accessories-block clearfix">
					...
					<div class="customNavigation">
						<a class="btn prev accessories_prev"><i class="icon-angle-left"></i></a>
						<a class="btn next accessories_next"><i class="icon-angle-right"></i></a>
					</div>
					{/if}
					<!-- Megnor End -->
					<div class="block_content">
						<ul id="{if $productCount >= $sliderFor}accessories-carousel{else}accessories-grid{/if}" class="{if $productCount >= $sliderFor}tm-carousel{else}product_list grid{/if} clearfix">
									...
									<li class="{if $productCount >= $sliderFor}item{else} ajax_block_product col-xs-12 col-sm-4 col-md-3 {/if} product-box {if $smarty.foreach.accessories_list.first} first_item {/if} {if $smarty.foreach.accessories_list.last} last_item {/if} ">
									 <div class="product-container" itemtype="http://schema.org/Product" itemscope="">
										...
										<div class="product-image-container">
											...
											{hook h="displayTmHoverImage" link_rewrite=$accessory.link_rewrite id_product=$accessory.id_product}
											</a>
