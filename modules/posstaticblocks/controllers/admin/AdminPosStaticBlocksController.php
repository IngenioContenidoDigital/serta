...
//        echo "<pre>"; print_r($listSlideshows); die;
    ...
    public function renderForm() {
        ...
        $listHookPosition = array(
            ...
            array('hook_position'=>'bannerTabcate'),
            array('hook_position'=>'blockDetailProduct'),
            array('hook_position'=>'bannerSlide'),
            array('hook_position'=>'brandSlider'),
/*             array('hook_position'=>'staticLeftColumn'),
            array('hook_position'=>'staticRightColumn'), */

        );
        $listHookPosition1 = array(
            array('hook_position'=> 'top'),
