...
class TminfoHeaderClass extends ObjectModel
{
	/** @var integer info id*/
	public $id;
		...
		if (count($this->fieldsValidateLang))
		{
			...
			foreach ($languages as $language)
				foreach ($this->fieldsValidateLang as $field => $validation)
					if (Tools::getValue($field.'_'.$language['id_lang']) != false)
						$this->{$field}[$language['id_lang']] = Tools::getValue($field.'_'.$language['id_lang']);
		}
	}
}
