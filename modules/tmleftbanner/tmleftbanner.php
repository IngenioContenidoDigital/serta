...
class TmLeftBanner extends Module
{
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('TM - Left Banner');
	...
	{
		/* Adds Module */
		if (parent::install() && $this->registerHook('leftColumn') && $this->registerHook('actionShopDataDuplication'))
		{
			/* Creates tables */
	...
	{
		if (!$this->isCached('tmleftbanner.tpl', $this->getCacheId()))
		{
	...
	public function hookLeftColumn()
	{
		if (!$this->_prepareHook())
			return false;
		return $this->display(__FILE__, 'tmleftbanner.tpl', $this->getCacheId());
	}
	public function clearCache()
	{
 		$this->_clearCache('tmleftbanner.tpl', $this->getCacheId());
	}
	...
	public function getSlides($active = null)
	{
		...
		return Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			SELECT hs.`id_tmleftbanner_slides` as id_slide, hssl.`image`, hss.`position`, hss.`active`, hssl.`title`,
			hssl.`url`, hssl.`image`
